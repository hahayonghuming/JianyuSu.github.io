...
**What happens if we apply two graph convolutions? The learned encoding contains information for nodes that are 2-hops away! (Great! The front vehicle can tell me what is going on in front of it!!!)**
